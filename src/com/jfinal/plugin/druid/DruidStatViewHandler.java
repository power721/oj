...
public class DruidStatViewHandler extends Handler
{
  ...
  public DruidStatViewHandler(String visitPath)
  {
    ...
    this.auth = new IDruidStatViewAuth() {
      ...
      {
        return SecurityUtils.getSubject().isPermitted("system");// 判断权限.
        // return true;
      }
    };
  }
  ...
  class JFinalStatViewServlet extends StatViewServlet
  {
    ...
    public void returnResourceFile(String fileName, String uri, HttpServletResponse response) throws ServletException, IOException
    {
