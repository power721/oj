...
(function () {
    ...
    window.UEDITOR_CONFIG = {
       ...
       // ,maxImageSideLength:1920                    //上传图片最大允许的边长，超过会自动等比缩放,不缩放就设置一个比较大的值，更多设置在image.html中
        ...
        //涂鸦图片配置区
        //,scrawlUrl: '/member/upload_image.aspx'           //涂鸦上传地址
       ...
       //,filePath:URL + "net/"                   //附件修正地址，同imagePath
        ...
        //图片在线管理配置区
        ,imageManagerUrl:BaseURL + "ueditor/imageManager"       //图片在线管理的处理地址
        ,imageManagerPath:BaseURL +"upload/"                                    //图片修正地址，同imagePath
        ...
        ,toolbars: [
			['fullscreen', 'source', 'preview', 'searchreplace', 'pagebreak', '|', 'undo', 'redo', '|', 'bold', 'italic', 'underline', 'strikethrough', 'superscript', 'subscript', 'removeformat', 'formatmatch', 'autotypeset', 'blockquote', 'pasteplain', '|', 'forecolor', 'backcolor', 'insertorderedlist', 'insertunorderedlist'], 
...
//           ]
        ...
        //,pageBreakTag:'_acfun_page_break_tag_'
