<@override name="contest_content">
    ...
    <#if (contest.type == "EXPERIMENT_EXAM" || contest.type == "COURSE_EXAM") && serverTime < contest.endTime>
        <div class="text-center">
            <form action="cprogram/generate/${contest.cid}" method="post" target="_blank">
                ...
                <input type='text' name='number' value="${number!}" style="width: 20px"
                ...
                <#if problems??>
                    <#list problems as Problem>
                        <tr class="problem" pid="${Problem.pid!}">
                            ...
                            <td class="maxSim" style="text-align: center">${Problem.maxSim!}%</td>
                            <td class="accept">
                ...
                <#if serverTime < contest.endTime>
                    ...
                    <tr>
                        <form class="form-inline" id="addProblem" action="api/contest/addProblem" method="post">
                            ...
                            <td><input type="number" name="pid" class="input-small" min="1000" placeholder="Problem ID"
                                       required></td>
                            <td><input type="text" name="title" class="input-xlarge" placeholder="Title" required></td>
                            <td></td>
                            <td></td>
                            <td>
                                <input type="number" name="maxSim" class="input-small" min="0" max="100" required
                                       value="100">%
                            </td>
                            <td>
        ...
        $(document).ready(function () {
            ...
            $(function () {
                $('#addProblem').submit(function () {
                    ...
                    var maxSim = $('input[name=maxSim]').val();
