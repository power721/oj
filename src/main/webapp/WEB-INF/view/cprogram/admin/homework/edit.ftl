<@override name="homework_content">
    ...
    <form class="form-horizontal" id="createContest" action="cprogram/admin/homework/update/${contest.cid}"
          method="post">
                ...
                <div class="input-prepend">
                    <select name="week" id="class_week" style="width: 124px">
                        <#list weeksMap.keySet() as week>
                            <option value="${week!}"
                                    <#if contest?? && week == contest.week >selected</#if> >
                                ${weeksMap.get(week!)}
                            </option>
                        </#list>
                    </select>
                    <select name="lecture" id="class_lecture" style="width: 124px">
                        <#list lecturesMap.keySet() as lecture>
                            <option value="${lecture!}"
                                    <#if contest?? && lecture==contest.lecture >selected</#if> >
