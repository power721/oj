...
/**
 * file info for problem data files. current implementation is for all files.
 * 
 * @author power
 *
 */
public class DataFile {
	...
	public DataFile(Integer pid, String name) {
		...
		path = new StringBuilder(5).append(OjConfig.getString("dataPath")).append(File.separator).append(pid)
