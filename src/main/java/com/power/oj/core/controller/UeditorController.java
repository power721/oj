...
public class UeditorController extends OjController {
    ...
    public void uploadImage() {
        ...
        renderJson(
            "{'original':'" + originalName + "','url':'" + url + "','title':'" + title + "','state':'" + state + "'}");
    }
    ...
    public void uploadProblemImage() {
        ...
        String fileName =
            new StringBuilder(3).append(OjConfig.problemImagePath).append(File.separator).append(originalName)
                .toString();
    ...
    public void uploadScrawl() {
        ...
        File outFile = new File(new StringBuilder(3).append(OjConfig.uploadPath).append(File.separator)
            .append(FileKit.getNewName("test.png")).toString());
        OutputStream ro;
        try {
