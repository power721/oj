...
public class FileKit {
	...
	private final static Logger log = Logger.getLogger(FileKit.class);
	...
	public static String getFileType(String fileName) {
		String[] fileType = { ".rar", ".doc", ".docx", ".zip", ".pdf", ".txt", ".swf", ".wmv", ".gif", ".png", ".jpg", ".jpeg",
				".bmp" };
	...
	public static String parsePath(String basePath, String path, boolean mkdirs) {
	...
	public static String parsePath(String path, boolean mkdirs) {
		return parsePath(PathKit.getWebRootPath(), path, mkdirs);
	}
