...
public class ProblemAdminController extends OjController {
	...
	public void exportProblems() {
		...
		if (xmlFile == null) {
			redirect("/admin/problem/export", new FlashMessage("Incorrect parameters!", MessageType.ERROR,
	...
	public void editData() {
		...
		if (content == null) {
			renderText("<p class=\"text-error\">Error occurred, please <a href=\"admin/problem/downloadData/" + pid + "?name="
