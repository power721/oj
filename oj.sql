...
-- ----------------------------
INSERT INTO `program_language` VALUES ('0', 'G++', '', '0', '996', '1', '1', 'cc', 'exe', '1', 'C:\\power\\oj\\JudgeOnline\\bin\\gcc\\bin\\g++.exe -fno-asm -s -w -O1 -DONLINE_JUDGE -o %PATH%%NAME% %PATH%%NAME%.%EXT%', 'cpp', '0', '1');
...
INSERT INTO `program_language` VALUES ('2', 'Pascal', '', '0', '1000', '1', '1', 'pas', 'exe', '0', 'C:\\power\\oj\\JudgeOnline\\bin\\fpc\\fpc.exe -Sg -dONLINE_JUDGE %PATH%%NAME%.%EXT%', 'pascal', '0', '1');
INSERT INTO `program_language` VALUES ('3', 'Java', '', '0', '8000', '3', '3', 'java', 'class', '2', 'C:\\power\\oj\\JudgeOnline\\bin\\Java\\Java.bat %PATH%', 'java', '0', '1');
INSERT INTO `program_language` VALUES ('4', 'Masm32', '', '0', '784', '1', '1', 'asm', 'exe', '1', 'C:\\power\\oj\\JudgeOnline\\bin\\asm\\masm32.bat %PATH% %NAME% %EXT%', 'xml', '0', '0');
